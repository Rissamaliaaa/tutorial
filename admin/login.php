...
<style type="text/css">
	body {
		background-image: url("/tutorial/images/headerlogo/background1.png");
...
<footer class="text-center" id="footeristik">&copy; Copyright 2019 created By COOLCLOTHES</footer>